    ...
    <div className="d-flex justify-content-center align-items-center loginPage pre-page">
      ...
      <div className="p-3 rounded border loginForm">
        ...
        <div className="login-header">
          ...
          <i className="bi bi-info-circle-fill info-icon" onClick={() => setIsModalOpen(true)}></i>
        </div>
      ...
      {isModalOpen && (
        <div className="modal" onClick={() => setIsModalOpen(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p><strong>Username:</strong> praveen@gmail.com</p> <p>(or)</p>
            <p><strong>Username:</strong> praveen</p>
